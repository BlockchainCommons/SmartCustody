...
_The following Adversaries are largely passed off to the hardware wallets holding keys in the transaction-coordinator scenario: Bitrot, Disaster, Key Fragility, Systemic Key Compromise, Supply-Chain Attack._
